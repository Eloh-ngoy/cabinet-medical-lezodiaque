...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p class="document-title">Rapport de Laboratoire</p>
        ...
        <div class="section">
            <h2 class="section-title">Détails de l'Analyse</h2>
            <div class="info-grid">
                <div class="info-row">
                    <span class="info-label">Type d'Analyse:</span>
                    <span class="info-value">{{ $analysis->analysis_type ?? 'Analyse de laboratoire' }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Date de Demande:</span>
                    <span class="info-value">{{ $analysis->requested_at->format('d/m/Y H:i') }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Médecin Demandeur:</span>
                    <span class="info-value">Dr. {{ $analysis->requestedBy?->full_name ?? 'Non renseigné' }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Statut:</span>
                    <span class="info-value">{{ $analysis->status }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="content-box">
                <p><strong>Validé par:</strong> Dr. {{ $analysis->validatedBy?->full_name ?? 'Non renseigné' }}</p>
                <p><strong>Date de validation:</strong> {{ $analysis->validated_at->format('d/m/Y H:i') }}</p>
            </div>
        </div>
        @endif
